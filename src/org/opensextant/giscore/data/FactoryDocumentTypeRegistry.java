...
public class FactoryDocumentTypeRegistry {
	private static Map<DocType, DocumentTypeRegistration> ms_register = new LinkedHashMap<DocType, DocumentTypeRegistration>(20);
	...
	static {
		...
		reg = new DocumentTypeRegistration(DocumentType.GeoAtom);
		reg.setInputStreamClass(GeoAtomInputStream.class);
		reg.setOutputStreamClass(GeoAtomOutputStream.class);
		FactoryDocumentTypeRegistry.put(DocumentType.GeoAtom.getDocType(), reg);
