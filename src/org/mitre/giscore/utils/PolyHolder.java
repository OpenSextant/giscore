...
public class PolyHolder {
	...
	/**
	 * @return get the current outer ring, may be <code>null</code>
	 */
	 ...
	 * @param ring the new inner ring, never <code>null</code>
	 */
	 ...
	 * @param ring the new outer ring, never <code>null</code>
	 */
