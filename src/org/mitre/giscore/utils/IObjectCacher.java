...
public interface IObjectCacher {
	 ...
	 * 
	 * @param outputObject
	 *            the object to consider, never <code>null</code>
	 * @return <code>true</code> indicates that this object should be cached and
	 ...
	 * 
	 * @param outputObject the object, never <code>null</code>
	 * @return <code>true</code> if the object is present in the cache.
	 */
	 ...
	 * @param outputObject
	 *            the object to consider, never <code>null</code>.
	 * @return a non-<code>null</code> Long will be returned
	 * @throws an IllegalStateException (unchecked) if the passed object
