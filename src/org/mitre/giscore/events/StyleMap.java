...
public class StyleMap extends StyleSelector {
    ...
    private final Map<String, Pair> mappings = new TreeMap<String, Pair>();
	...
	/*
	 * Add key/url Pair to StyleMap.
	 * @return the previous Pair associated with same key assigned to <tt>pair</tt>, or
	 *         <tt>null</tt> if there was no mapping for its key.
	 */
	 ...
	 * @return StyleUrl associated with key or <tt>null</tt> if no pair is found
	 * 		or the styleUrl for that key is <tt>null</tt>.
	 */
	@CheckForNull
	...
	/**
	 * Lookup a particular StyleMap Pair given its <tt>key</tt>.
	 * @param key the key whose associated value is to be returned
	 * @return Pair associated with key or <tt>null</tt> if no pair is found.
	 */
	@CheckForNull
	 ...
	 * @return iterator for collection of keys, which is typically <tt>normal</tt>
	 * and <tt>highlight</tt> in a KML context.
	 */
	@NonNull
