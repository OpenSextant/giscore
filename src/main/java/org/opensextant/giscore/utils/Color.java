...
/**
 * This Color class is a light-weight replacement for <code>java.awt.Color</code>,
 ...
 * <code>java.awt.Color</code> and acts as a direct replacement. Most code
...
public class Color implements Serializable {
	...
	/**
	 * Creates an RGB color with the specified <code>java.awt.Color</code> instance
	 *
	 * @param c the Color
	 ...
	 * The returned string cannot be <code>null</code>.
	 *
	...
	/**
	 * Convert to a <code>java.awt.Color</code> instance with an opaque
	 * RGB color.
	 */
	@NonNull
	...
	/**
	 * Convert to a <code>java.awt.Color</code> instance.
	 * If the <code>hasAlpha</code> argument is <code>false</code>, alpha
	 * is defaulted to 255.
	 *
	 * @param hasAlpha <code>true</code> if the alpha bits are valid;
