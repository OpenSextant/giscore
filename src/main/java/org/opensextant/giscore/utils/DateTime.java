...
/**
 * The class <code>DateTime</code> represents a specific instant
...
public class DateTime implements java.io.Serializable, Cloneable, Comparable<DateTime> {
	...
	/**
	 * Constructs a <code>DateTime</code> object and initializes it so that
	...
	/**
	 * Constructs a <code>DateTime</code> object and initializes it to
	 ...
	 * not <code>null</code> and is a <code>DateTime</code> object that
	 ...
	 * @return  the value <code>0</code> if the argument DateTime is equal to
	 *          this DateTime; a value less than <code>0</code> if this DateTime
	 *          is before the DateTime argument; and a value greater than
	 *      <code>0</code> if this DateTime is after the DateTime argument.
	 * @since   1.2
	 ...
	 * <li><i>MM</i> is the month, as two decimal digits.
	 * <li><i>DD/i> is the day of the month (<tt>01</tt> through <tt>31</tt>),
	 ...
	 *     <tt>60</tt>), as two decimal digits.
	 * </ul>
	...
	/**
	 * Formats the given <code>DateTime</code> into a date/time string using format
