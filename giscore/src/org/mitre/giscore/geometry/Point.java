...
/**
 * The Point class represents a single Geodetic point (Geodetic2DPoint or Geodetic3DPoint)
 * for input and output in GIS formats such as ESRI Shapefiles or Google Earth KML files.
 * In ESRI Shapefiles, this object corresponds to a ShapeType of Point or PointZ. In Google
 * KML files, this object corresponds to a Geometry object of type Point.
 *
 * @author Paul Silvey
 */
public class Point extends Geometry {
     ...
     *
     * @param gp GeoPoint to initialize this Point with (must be Geodetic form)
     * @throws IllegalArgumentException error if object is not valid.
     */
    public Point(GeoPoint gp) throws IllegalArgumentException {
        if (gp == null) throw new IllegalArgumentException("Point must not be null");
     ...
     *
     * @param that Point to compare against this one.
